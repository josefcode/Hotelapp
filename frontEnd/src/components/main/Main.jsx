...
export default function Main() {
  ...
  const requestConfig = {
    ...
    headers: {
      ...
      "Authorization": "Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJtYXJjZWxvX21iZ0Bob3RtYWlsLmNvbSIsImV4cCI6MTY3OTUwNDg3NSwiaWF0IjoxNjc5NTA0Mjc1fQ.ZBNZedlT6VedMJbogDZurmoW-TZq9xwvHQ9v_S4FYks",
    }
  };
  ...
  React.useEffect(() => {
    async function fetchData() {
      ...
      setProduto(data)
      setIsLoading(true); // altera o valor de isLoading para false
    }
